...
import { playEmptySound, playRegularSound, playShellSound } from "./sounds.js";
...
export class TurnBasedClickGame {
  ...
  setupEventListeners() {
    elements.shotgunButton.addEventListener("click", () => this.handleClick());
    elements.player1Button.addEventListener("click", () =>
      this.handlePlayerClick(1)
    );
    elements.player2Button.addEventListener("click", () =>
  ...
  handleClick() {
    ...
    elements.player1Button.style.pointerEvents = "all";
    elements.player2Button.style.pointerEvents = "all";
  }
  ...
  handlePlayerClick(playerNum) {
    ...
    setTimeout(() => {
      ...
      this.updateLivesDisplay();
      elements.player1Button.style.pointerEvents = "none";
      elements.player2Button.style.pointerEvents = "none";
    }, 750);
  }
  ...
  handleAnimation(playerNum) {
    ...
    elements.shotgunButton.classList.add(animationClass);
    setTimeout(() => {
      elements.shotgunButton.classList.remove(animationClass);
    }, 750);
  }
  ...
  updateLivesDisplay() {
    ...
    elements.player1Button.classList.toggle("active", this.currentPlayer === 1);
    elements.player2Button.classList.toggle("active", this.currentPlayer === 2);
  }
